...
public class JCVideoPlayerStandard extends JCVideoPlayer {
    ...
    public void init(Context context) {
        ...
        shareImage = (ImageView) findViewById(R.id.shareImg);
    ...
    public void setUiWitStateAndScreen(int state) {
        ...
        switch (currentState) {
            ...
            case CURRENT_STATE_AUTO_COMPLETE:
                ...
                //播放結束后顯示分享按鈕，修改播放圖片為重播，顯示視頻長度
                shareButton.setVisibility(VISIBLE);
                startButton.setImageResource(R.drawable.chongboanniu2x);
...
//            }
            ...
            shareButton.setVisibility(GONE);
        } else if(i== R.id.shareImg){
            backPress();
            if(null != JCMediaManager.instance().needShareListener)
                JCMediaManager.instance().needShareListener.isNeedShare(true);
        }
    }
