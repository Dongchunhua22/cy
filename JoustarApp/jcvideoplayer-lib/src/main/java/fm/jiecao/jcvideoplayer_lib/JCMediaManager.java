...
public class JCMediaManager implements ExoPlayer.EventListener, SimpleExoPlayer.VideoListener, TextureView.SurfaceTextureListener {
    ...
    public IGetVedioPlayerProress vedioPlayerProress;
    public synchronized static fm.jiecao.jcvideoplayer_lib.JCMediaManager instance() {
            ...
            switch (msg.what) {
                case HANDLER_PREPARE:
                    try {
                        ...
                        simpleExoPlayer.addListener(fm.jiecao.jcvideoplayer_lib.JCMediaManager.this);
                        simpleExoPlayer.setVideoListener(fm.jiecao.jcvideoplayer_lib.JCMediaManager.this);
...
//                    simpleExoPlayer = null;
                    Log.i(TAG,"release simpleExoPlayer");
                    break;
            }
        }
    }
    ...
    public void prepare(final Context context, final String url, final Map<String, String> mapHeadData, boolean loop) {
        ...
        Log.i(TAG,"prepare release simple");
        releaseMediaPlayer();
